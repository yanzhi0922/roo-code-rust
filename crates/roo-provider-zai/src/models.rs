...
/// Returns the supported ZAI models.
pub fn models() -> HashMap<String, ModelInfo> {
    ...
    m.insert(
        ...
        ModelInfo {
            ...
            cache_reads_price: Some(0.11),
            description: Some(
                "GLM-4.5V is Z.AI's multimodal visual reasoning model (image/video/text/file input), \
                 optimized for GUI tasks, grounding, and document/video understanding."
                    .to_string(),
            ),
            ..Default::default()
        },
